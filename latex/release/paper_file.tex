...
\affiliation{
  \institution{Dept. Name of Organization}
  \city{City}
  \country{Country}
}
...
\keywords{SAP ERP, IIoT Data Integration, Explainable Artificial Intelligence, Human-in-the-Loop Decision Making, Predictive Analytics, Machine Learning, Operational Optimization, Enterprise Systems}
...
\begin{figure}[htbp]
\centering
\input{../../results/decision_layer_pipeline.tex}
...
\centering
\input{../../results/target_distribution_table.tex}
\end{table}
...
\centering
\input{../../results/chi_square_results_table.tex}
\end{table}
...
\input{../../results/table_model_performance.tex}
\end{table}
...
\begin{figure}[htbp]
\centering
\input{../../results/model_comparison_chart.tex}
...
\input{../../results/table_calibration.tex}
\end{table}
